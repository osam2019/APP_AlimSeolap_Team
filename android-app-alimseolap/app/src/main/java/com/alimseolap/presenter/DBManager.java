...
public class DBManager {
    ...
    public void updateNotiWeight(int notiId, boolean isPositive) {
        ...
        //````````````````````````````````````````````````````````````````````````````````````````````````//
        //한 알림으로 묶여있는 명사의 개수를 가져옵니다.
        int relateive_num = nLinks.length;
        //................................................................................................//

        String operator = isPositive ? "+" : "-";

        //````````````````````````````````````````````````````````````````````````````````````````````````//
        //weight 변화값이 실수화 되어 있을 수도 있기 때문에 int 값으로 변환해줍니다.
        int weight_num = 100/relateive_num;
        //................................................................................................//


        for(int i=0; i<nLinks.length; i++)
            db.execSQL("update noun set weight = weight" + operator + weight_num + " where id=" + nLinks[i]);
    }
